...
describe('test changeColor function', ()  => {
  ...
  /*  test('change color to cyan',async () => {
    ...
    test('change color to firebrick',async () => {
    ...
    test('change color to skyblue',async () => {
    ...
    test('change color to springgreen',async () => {
